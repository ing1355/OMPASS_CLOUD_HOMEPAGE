...
// export const domainRegex = /^(https?:\/\/)?(([a-zA-Z0-9-]+\.)+[a-zA-Z]{2,}|(\d{1,3}\.){3}\d{1,3})(:\d+)?(\/.*)?$/
export const domainRegex = /^[a-zA-Z0-9]{3,30}/

export const redirectUriRegex = /^(\/[a-zA-Z0-9\-_\/\.]*)?(\?[a-zA-Z0-9\-_\.=]*(?:&[a-zA-Z0-9\-_\.=]*)*)?(#[a-zA-Z0-9\-_\.]*)?$/