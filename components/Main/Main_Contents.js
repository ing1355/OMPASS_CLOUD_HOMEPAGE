...
function Main_Contents() {
  ...
  return (
    <div className="cloud-div">
      <div className="CloudcontentsBox1">
      ...
      <div className="CloudcontentsBox2">
      ...
      <div className="CloudcontentsBox3">
        <ul className="contentsSubBox">
          <li>
            <h2>{t("주요기능 (경쟁력)")}</h2>
            <div className="contents2Box">
              <div className="contents2Title cloud">
                <ul>
                  <li
                    onMouseOver={() => {
                      setShow1(true);
                  ...
                  <ul>
                    <ul>
                      ...
                      <li>
                        ...
                        <p>
                          {t(
                            "웹기반 서비스, 윈도우즈 클라이언트, 윈도우즈 로그인, 모바일앱, 리눅스 PAM, MacOS 클라이언트 연동 가능"
                          )}
                        </p>
                      </li>
                ...
                {show3 === true ? (
                  <ul>
                    <ul>
                      ...
                      <li>
                        <h5>{t("모바일 인증장치 보안성 강화")}</h5>
                        <p>
                          {t(
                            "모바일 인증장치 탈옥, 위변조 및 최신버전 여부 검증 기능 적용"
                          )}
                        </p>
                      </li>
                    </ul>
      ...
      <div className="CloudcontentsBox5" id="cloud">
        <div className="contentsSubBox">
          {/* <h2>주요 화면</h2> */}
          <ul>
            <li>
      ...
      <div className="contentsBox6 cloudVideo">
        <div className="contentsSubBox">
          <h2>{t("원모어패스 시연영상")}</h2>
          <div className="videoDiv">
            <iframe
              ...
              src={
                isKr
                  ? "https://www.youtube.com/embed/KsFukpPL6wg?si=4nt0Lod5UMzM6fyL"
