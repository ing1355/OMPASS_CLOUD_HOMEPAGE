...
import styles from "../../css/Build_Contents.module.css";
...
function Contents() {
  ...
  return (
    <>
      <div className={styles["contentsBox1"]}>
      ...
      <div className={styles["contentsBox2"]}>
      ...
      <div className={styles["contentsBox3"]}>
        <ul className={styles["contentsSubBox"]}>
          <li>
            <h2>{t("주요기능 (경쟁력)")}</h2>
            <div className={styles["contents2Box"]}>
              <div className={styles["contents2Title"]}>
                ...
                {show === 1 ? (
                  <ul>
                    <ul>
                      ...
                      {/* <MainContents title="원모어페이스 모듈적용, 한국인터넷진흥원 K-NBTC 인증, 99.96%" content="중앙 통제형 얼굴인증을 별도로 제공합니다." /> */}
                    </ul>
                  </ul>
                ) : null}
                ...
                {show === 2 ? (
                  <ul>
                    <ul>
                      ...
                      <MainContents title="네트워크 환경 최적화" content="인터넷망·폐쇄망 환경 완벽 지원" />
                ...
                {show === 3 ? (
                  <ul>
                    <ul>
                      ...
                      <MainContents title="관리자 인증 강화" content="FIDO2 Admin 서버 접근 시 OMPASS 2차 인증 적용2" />
      ...
      <div className={styles["contentsBox4"]}>
        <div className={styles["contentsSubBox"]}>
          <h2>{t("사양·구성도")}</h2>
          <img
            className={`${styles["omapss"]} ${styles["DiagramImg"]}`}
            src={
              isKr
      ...
      <div className={styles["contentsBox5"]}>
        <div className={styles["contentsSubBox"]}>
          {/* <h2>주요 화면</h2> */}
          <ul>
            <li>
            ...
            <li>
              ...
              <span>
                ▶{" "}
                <ShowImgIcon src="/static/images/1.png" alt="지문인식 아이콘" title="지문" />
                <ShowImgIcon src="/static/images/2.png" alt="얼굴인식 아이콘" title="얼굴인식" />
                <ShowImgIcon src="/static/images/3.png" alt="패턴 아이콘" title="패턴" />
                <ShowImgIcon src="/static/images/4.png" alt="핀 코드 아이콘" title="핀코드" isLast />
              </span>
            </li>
          </ul>
        </div>
      </div>
      <div className={styles["contentsBox6"]}>
        <div className={styles["contentsSubBox"]}>
          <h2>{t("소개영상")}</h2>
      ...
      <div className={`${styles["contentsBox6"]} ${styles["contentsBox7"]}`}>
        <ServiceText/>
      </div>
    </>
  );
