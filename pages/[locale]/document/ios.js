...
function ios(props) {
  ...
  return (
    <div className="document iOSbox">
      <ul className="documentLeft">
        <Document document_IOS={document_IOS} />
      </ul>
              ...
              <div class="main">
                <div className="code">
                  ...
                  <div className="qrcode-mobile">
                    ...
                    >
                      {t(
                        "iOS 전용 앱 스토어에서 원모어패스(OMPASS) v1.0을 다운로드하여 설치해야 합니다."
                      )}
                      <br />
                  ...
                  <div className="document-text-box">
                    ...
                    <div className="documnet-box">
                      ...
                      <div className="document-label">
                        ...
                        <p>
                          {t(
                            "얼굴인식, PIN CODE, 패턴 3가지 인증방식 중 2가지 이상 등록해야 합니다."
                          )}
                        </p>
                      </div>
                    </div>
